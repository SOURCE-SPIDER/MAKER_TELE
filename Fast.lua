...
bot = Fx.Fastbots.set_config{api_id=10022445,api_hash='e914dd8baba8b1cb250b6066cd24d445',session_name=Fast,token=Token}
function var(value)
...
send(data.chat_id,data.id,"⎊ اهلا بك في صانع تيليثون سورس سبايدر \n⎊ مبرمج السورس @WWWL5","html",true, false, false, true, reply_markup)
return false 
end
...
Redis:set(Fast..data.sender_id.user_id.."make:bot","token")
send(data.chat_id,data.id, "\n⎊ ارسل توكن البوت المساعد الان","md",true)  
return false 
end 
----end making user
