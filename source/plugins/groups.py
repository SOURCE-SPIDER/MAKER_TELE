...
async def mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 5656828413:
            return await msg.edit("⎈ لا يمكنك كتم فينوم")
...
async def un_mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 5656828413:
            return await msg.edit("⎈ لا يمكنك الغاء كتم فينوم")
...
async def bann(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 5656828413:
        return await msg.edit("⎈ لا يمكنك حظر فينوم")
    try:
...
async def un_ban(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 5656828413:
        return await msg.edit("⎈ لا يمكنك الغاء حظر فينوم")
    try:
