...
⎈ قبول ، رفض
⎈ كتم ، الغاء كتم 
⎈ سبام + الكلمه + الرقم (سبام اسامة 22)
⎈ ايدي + ايدي بالرد
 ⌯︙ @EE_20
"""
txx2 = """
...
⎈ تفعيل ، تعطيل الساعه 
⎈ تغيير اسمي + الاسم (تغيير اسمي SEVEN)
⎈ سورس
 ⌯︙ @EE_20
"""
...
async def back(client, callback_query):
  await callback_query.edit_message_text("⎈ اهلا بك في اوامر تيلثون سيڤين\n⎈ ① اوامر الخاص\n⎈ ② اوامر القنوات والمجموعات \n⎈ ③ اوامر اليوتيوب \n⎈ ④ اوامر الاذاعه\n⎈ ⑤ اوامر التسليه \n⎈ ⑥ اوامر اضافيه",reply_markup = InlineKeyboardMarkup(
            [[
             ...
             [
             InlineKeyboardButton("𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝗘𝗡𝗢𝗠",url="https://t.me/EE_20"),
             ],
             [
             InlineKeyboardButton("𝗠𝗔𝗞𝗘𝗥 𝗩𝗘𝗡𝗢𝗠",url="https://t.me/G3SEVENbot"),
             ]]
             ))
